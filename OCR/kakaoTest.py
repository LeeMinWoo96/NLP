...
def main():
   ...
   #     print("Please run with args: $ python example.py /path/to/image appkey")
    ...
    # 본인 key
    image_path, appkey = './page_6.jpg','key'
...
#    data = json.dumps(output)
    ...
    fileOut = open("./kakaoResult.txt", "w", encoding="utf-8")
    fileOut.write(' '.join(output["result"]["recognition_words"])) 
    
    # original json file save
    #fileOut = open("./kakaoResult.json", "w", encoding="utf-8")
